...
xbmc.log(f'Filmezek | v{version} | OS: {os_info}', xbmc.LOGINFO)
...
class navigator:
    ...
    def getItems(self, url):
        ...
        try:
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | getItems | next_page_url | csak egy oldal található', xbmc.LOGINFO)
    ...
    def getSeriesProviders(self, url):
        ...
        try:
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | getSeriesProviders | name: No video sources found', xbmc.LOGINFO)
    ...
    def getMovieItems(self, url):
        ...
        try:
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | getMovieItems | next_page_url | csak egy oldal található', xbmc.LOGINFO)
    ...
    def getSeriesItems(self, url):
        ...
        try:
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | getSeriesItems | next_page_url | csak egy oldal található', xbmc.LOGINFO)
    ...
    def playMovie(self, url):
        ...
        try:
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | playMovie | direct_url: {direct_url}', xbmc.LOGINFO)
            ...
            xbmc.log(f'Filmezek | v{version} | OS: {os_info} | playMovie | name: No video sources found', xbmc.LOGINFO)
            notification = xbmcgui.Dialog()
